...
- [ ] `npm run parity:compare` is green against the committed baselines in `scripts/.parity/` (162/162 on FBCM as of 2026-09-20). Build first; the harness never builds. Run it on any change meant to be render-neutral, and recapture only deliberately, once, when the pages have stopped moving.
